<template>
  <div v-loading="loading" class="w-full">
    ...
    <div class="bg-view-body pl-4 pr-4">
      <Model1 class="model1 w-full" title="采购金额逐月分析">
      ...
      <Model1 class="model1" title="采购金额构成分析">
        <div class="model-body">
          <div class="model-body__content">
      ...
      <!-- <div class="b-space" /> -->
      <div class="flex gap-2">
        <Model1 v-if="hasSubOrg" class="model1" title="下属企业采购金额分析">
          <div class="model-body">
        ...
        <Model1 v-if="hasProduct" class="model1" title="产品采购金额分析">
          <div class="model-body">
            <div class="model-body__content mx-4 my-2 flex gap-2">
              <table class="sub-org-table m-auto">
                <thead>
