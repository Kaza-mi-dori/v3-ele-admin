<template>
  <div class="main-wrapper">
    ...
    <div class="title-block">
      <div class="__title">主营产品经营报表</div>
      <div class="__stat">
    ...
    >
      ...
      <!-- 聚合标签 -->
      <el-table-column prop="name" label="企业" sortable align="center">
        <template v-slot="scope">
...
const handleExportExcel = () => {
  // console.log("导出excel");
  BusinessFormAPI.exportMonthlyProductReportForm({
    聚合标签: ["产品类型年报"],
  }).then((res: any) => {
    const fileName = decodeURI(`主营产品经营报表.xlsx`);
    const fileType =
