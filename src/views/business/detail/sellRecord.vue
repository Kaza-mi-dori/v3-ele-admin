...
const sellRecordForm: Ref<business.IPurchaseRecord> = ref({
  id: "",
  公司名称: "",
  日期: "",
  合同编号: "",
...
const { history, commit, undo, redo } = useManualRefHistory(sellRecordForm, {
  clone: true,
});
...
const getFormValue = () => {
  return unref(sellRecordForm.value);
};
const setFormValue = (value: any) => {
  if (value) {
    saveForm();
    sellRecordForm.value = value;
  }
};
const validateForm = () => {
